...
def run():
    ...
    """
    inputs = {
        'topic': 'B2B LinkedIn Marketing Strategy for Solar Panel Suppliers targeting Real Estate Developers',
...
def test():
    ...
    try:
        Sample().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
